!(function (e) {
  ...
  function (e, t, n) {
    ...
    (t.TrackNameCharsInvalidError = J),
      Object.defineProperty(a, 53303, { value: J });
    var $ = (function (e) {
      function t() {
    ...
    (t.TrackNameIsDuplicatedError = $),
      Object.defineProperty(a, 53304, { value: $ });
    var X = (function (e) {
      function t() {
        var n =
          e.call(
  ...
  function (e, t, n) {
    ...
    e.exports = function (e, t) {
      ...
      var te = new c(
        ...
        ne = {
          audio: t.preferredAudioCodecs.map($),
          video: t.preferredVideoCodecs.map($),
        },
  ...
  function (e, t, n) {
    "use strict";
    const r = n(120),
      i = document.getElementById("audiopreview"),
      o = document.getElementById("videopreview"),
      a = document.getElementById("muteBtn"),
      s = document.getElementById("unmuteBtn"),
      c = document.getElementById("micTxt"),
      u = document.getElementById("muteVideoBtn"),
      l = document.getElementById("unmuteVideoBtn"),
      d = document.getElementById("camTxt"),
      p = document.getElementById("micDisabled"),
      f = document.getElementById("raisehand");
    let h = null,
      v = null,
      m = !1,
      y = null,
    ...
    function T(e, t) {
      e.isSubscribed && t.appendChild(e.track.attach()),
        e.on("subscribed", (n) => {
          t.appendChild(e.track.attach());
        }),
        e.on("unsubscribed", k);
    }
    function O(e) {
      ...
      (v = e),
        ...
        e.participants.forEach((e) => {
          if (e.identity === h)
            ...
            (t.id = "audioPreview_" + e.identity), O(e);
          }
        }),
    ...
    function E(e, t) {
      ...
      navigator.mediaDevices.enumerateDevices().then((o) => {
        o.forEach((e) => {
          "audioinput" === e.kind && b
            ? (n = !0)
            : "videoinput" === e.kind && w && (i = !0);
        }),
          (y = r
            .connect(e, { name: t, video: i, audio: n, dominantSpeaker: !0 })
            .then(C, (e) => {
              console.log(e);
            }));
      });
    ...
    function R(e, t, n) {
      navigator.mediaDevices
        .getUserMedia(e)
        .then((e) => {
          console.log("Got audio access"), (b = !0), E(t, n);
        })
        .catch((e) => {
          "NotAllowedError" == e.name && (console.log(e), (b = !1), E(t, n));
        });
    }
    !(async function () {
      ...
      const { token: t } = e,
        { teacher: n } = e;
      h = n;
      const r = new URL(window.location).searchParams.get("room");
      let i = { audio: !0 };
      navigator.mediaDevices
        ...
        .catch((e) => {
          "NotAllowedError" == e.name && (console.log(e), (w = !1)), R(i, t, r);
        }),
        (a.onmouseout = () => {
          ...
          switch (e.type) {
            case "muteStudents":
              if ("mute" === e.action)
                ...
                m && (s.click(), g && (p.style.display = "none"));
                ...
                "forceUnmute" === e.action &&
                  ((g = !1), m && ((p.style.display = "none"), s.click()));
          }
        }),
