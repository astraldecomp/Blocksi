!(function (e) {
  ...
  function (e, t, n) {
    (function (e) {
      ...
      (t.debuglog = function (n) {
        if (
          (_(o) && (o = e.env.NODE_DEBUG || ""), (n = n.toUpperCase()), !a[n])
        )
    ...
    var d = (function () {
      ...
      return (
        ...
        (e.prototype.setLevels = function (e) {
          return m(e), Object.assign(this._logLevels, e), this;
        }),
  ...
  function (e, t, n) {
    ...
    (t.SignalingConnectionTimeoutError = m),
      Object.defineProperty(a, 53002, { value: m });
    var y = (function (e) {
      function t() {
        var n =
    ...
    (t.SignalingIncomingMessageInvalidError = y),
      Object.defineProperty(a, 53003, { value: y });
    var _ = (function (e) {
      function t() {
        var n =
    ...
    (t.SignalingOutgoingMessageInvalidError = _),
      Object.defineProperty(a, 53004, { value: _ });
    var g = (function (e) {
      function t() {
    ...
    (t.RoomStatusCallbackInvalidError = L),
      Object.defineProperty(a, 53111, { value: L });
    var j = (function (e) {
      function t() {
    ...
    (t.RoomStatusInvalidError = j),
      Object.defineProperty(a, 53112, { value: j });
    var A = (function (e) {
      function t() {
    ...
    (t.RoomAudioOnlyFlagNotSupportedError = B),
      Object.defineProperty(a, 53124, { value: B });
    var F = (function (e) {
      function t() {
        var n =
    ...
    (t.RoomTrackKindNotSupportedError = F),
      Object.defineProperty(a, 53125, { value: F });
    var U = (function (e) {
      function t() {
  ...
  function (e, t, n) {
    ...
    function k(e) {
      ...
      return (
        _.onVisibilityChange(1, v),
        l(),
        function () {
          _.offVisibilityChange(1, v), p();
        }
      );
    }
  ...
  function (e, t, n) {
    ...
    (function (t) {
      var r,
        ...
        m = { closed: "close", open: "open", waiting: "waiting" },
        y = t.window || t,
        _ = y.WebSocket ? y.WebSocket : n(72),
        g = {
          BUSY: "busy",
          FAILED: "failed",
          LOCAL: "local",
            ...
            return (
              r.on("stateChanged", function (e) {
                for (var t = [], n = 1; n < arguments.length; n++)
                  t[n - 1] = arguments[n];
                e in m && r.emit.apply(r, a([m[e]], o(t)));
      ...
      m = (function (e) {
        function t(t, n) {
          ...
          return (
            ...
            r._tracks.forEach(y.bind(null, r)),
    ...
    var r,
      ...
      y = (function (e) {
        function t(t, n, r, i) {
          ...
          var d = c(i.logLevel);
          a = e.call(this, "connected", m) || this;
  ...
  function (e, t, n) {
                ...
                (function (e) {
                  ...
                  return (
                    (c ? [t] : n).forEach(function (e) {
                      ...
                      "number" == typeof m &&
                        (c
                          ? (t.frameHeightReceived = m)
                          : ((t.frameHeightSent = m),
                            (t.frameHeightInput = o.frameHeight)));
                      var y = r("framesPerSecond");
                      "number" == typeof y &&
                        (t[c ? "frameRateReceived" : "frameRateSent"] = y);
                      var _ = r("bytesReceived");
                      "number" == typeof _ && (t.bytesReceived = _);
                      var g = r("bytesSent");
                      ...
                      var L = r("jitterBufferEmittedCount");
                      "number" == typeof L && (t.jitterBufferEmittedCount = L),
                        u.push(t);
                    }),
                    u
                  );
    ...
    function _(e, t) {
      ...
      var m = a("bytesReceived");
      "number" == typeof m && (s.bytesReceived = m);
      var y = a("packetsReceived");
      "number" == typeof y && (s.packetsReceived = y);
      var _ = a("framerateMean");
      "number" == typeof _ && (s.frameRateReceived = Math.round(_));
  ...
  function (e, t, n) {
    ...
    function h(e, t, n) {
      ...
      return r || e._peerConnection[c](m(n));
    }
    function v(e, t) {
      ...
      V = (function (e) {
        ...
        return (
              ...
              return s(this, function (k) {
                switch (k.label) {
                  ...
                  case 4:
                    return (
                      (m = k.sent()),
                      this.emit("debug", { remoteTracks: m }),
                    ...
                    return (
                      ...
                      [
                        ...
                        this._executePreflightStep(
                          "Generate report",
                          function () {
                            return w._generatePreflightReport(y);
                          }
                        ),
                      ]
                    );
          ...
          (t.prototype._collectRTCStats = function (e, t, n) {
            return a(this, void 0, void 0, function () {
              var r, i, o, a, c, u, p, f, h, v, m, y, _, g;
              return s(this, function (s) {
                switch (s.label) {
                  case 0:
                    return [
                  ...
                  case 1:
                    return (
                      ...
                      m &&
                        ...
                        (y = this._packetLossMovingAverage.get()),
                        (_ = Math.min(100, 100 * y)),
                        e.packetLoss.push(_),
                        (g = l.calculateMOS(p, f, y)),
                        e.mos.push(g)),
                      e.selectedIceCandidatePairStats ||
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      (t.getCombinedConnectionStats = function (e) {
        ...
        return r(this, void 0, void 0, function () {
          var e, r, c, u, l, d, p, f, h, v, m, y, _, g, b;
            ...
            switch (i.label) {
              ...
              case 1:
                return (
                  ...
                  (m = 1e3 * (v || h)),
                  (y = a(r, "bytesSent", [], ["candidate-pair"]).reduce(
                    function (e, t) {
                      return e + t;
                    },
                    0
                  )),
                  (_ = a(c, "bytesReceived", [], ["candidate-pair"]).reduce(
                    function (e, t) {
                      return e + t;
                    },
                    0
  ...
  function (e, t, n) {
    ...
    e.exports = function (e, t) {
      ...
      var V = new (t.insights ? l : d)(e, L, j, t.environment, t.realm, T),
      ...
      var te = new c(
        ...
        re = new m(S(t.networkQuality) ? t.networkQuality : {}),
        ie = s(
          $.bind(null, t),
            ...
            v.emit("event", D),
              k.once("connected", function (e) {
                if ((g.debug("Transport connected:", e), o())) i(S);
                  ...
                  n.setSignalingRegion(t), r(new m(n, e, k, b, f));
                } else i(new u());
              }),
  ...
  function (e, t, n) {
    ...
    var r,
      ...
      m = h.DEFAULT_LOG_LEVEL,
      y = h.DEFAULT_SESSION_TIMEOUT_SEC,
      _ = h.iceRestartBackoffConfig,
      g = n(39),
      ...
      L = n(14),
      j = n(9),
      A = j.MediaClientLocalDescFailedError,
      D = j.MediaClientRemoteDescFailedError,
      I = n(1),
      M = I.buildLogLevels,
      N = I.getPlatform,
        ...
        function t(t, n, r, i) {
          ...
          i.dummyAudioMediaStreamTrack &&
            ...
            Object.defineProperties(o, {
              ...
              _iceRestartBackoff: { value: i.Backoff.exponential(_) },
  ...
  function (e, t, n) {
    ...
    var r,
      ...
      m = n(220),
      y = n(1),
      _ = y.constants.DEFAULT_SESSION_TIMEOUT_SEC,
      g = y.createBandwidthProfilePayload,
      b = y.defer,
      w = y.difference,
      k = y.filterObject,
      S = y.flatMap,
      ...
      C = (function (e) {
        function t(t, n, r, i, o) {
          var l = this;
          (n.options = Object.assign({ session_timeout: _ }, n.options)),
            (o = Object.assign(
              {
          ...
          return (
            Object.defineProperties(l, {
              ...
              _dominantSpeakerSignaling: {
                value: new o.DominantSpeakerSignaling(y, { log: g }),
              },
              ...
              _renderHintsSignaling: { value: new v(y, { log: g }) },
              _publisherHintsSignaling: { value: new m(y, { log: g }) },
              _trackPrioritySignaling: {
                value: new o.TrackPrioritySignaling(y, { log: g }),
              },
              _trackSwitchOffSignaling: {
                value: new o.TrackSwitchOffSignaling(y, { log: g }),
              },
  ...
  function (e, t, n) {
    ...
    var r,
      ...
      m = h.createMediaSignalingPayload,
      y = h.createSubscribePayload,
      _ = h.getUserAgent,
            ...
            return (
              "connect" === t.type
                ? ((t.ice_servers = this._iceServersStatus),
                  ...
                  (t.subscribe = y(this._automaticSubscription)),
                  (t.format = f),
  ...
  function (e, t, n) {
    "use strict";
    const r = n(120),
      i = document.getElementById("muteBtn"),
      o = document.getElementById("unmuteBtn"),
      a = document.getElementById("micTxt"),
      s = document.getElementById("muteVideoBtn"),
      c = document.getElementById("unmuteVideoBtn"),
      u = document.getElementById("liTeacher"),
      l = document.getElementsByClassName("liTeacher")[0],
      d = document.getElementById("camTxt"),
      p = document.getElementById("raisehand"),
      f = document.getElementById("micDisabled"),
      h = document.getElementById("classTitle");
    let v = null,
      m = null,
      y = !1,
      _ = null,
    ...
    function C(e, t, n) {
      ("audio" === t
        ? e.localParticipant.audioTracks
        : e.localParticipant.videoTracks
      ).forEach(function (e) {
        "mute" === n ? e.track.disable() : e.track.enable();
      });
    }
    function E() {
      (T = []),
        m.participants.forEach((e) => {
          e.identity !== v &&
            e.tracks.forEach((t) => {
              !T.includes(e.identity) &&
                T.length < 10 &&
                t.track.isEnabled &&
                !t.track.isSwitchedOff &&
                "video" === t.kind &&
                (T.push(e.identity),
                (document.getElementById(
                  "studentVideo_" + e.identity
                ).style.display = ""));
            });
        });
      for (var e = 10 - T.length; e > 0; )
        T.length < 10 &&
          O.forEach((e) => {
            !T.includes(e) &&
              T.length < 10 &&
              (T.push(e),
              (document.getElementById("studentVideo_" + e).style.display =
                ""));
          }),
          e--;
      O.forEach((e) => {
        T.includes(e) ||
          (document.getElementById("studentVideo_" + e).style.display = "none");
      });
    }
    function R(e, t, n) {
      if (e.isSubscribed) {
        const r = e.track.attach();
        "video" === e.kind &&
          ((r.style.display = "block"),
          r.setAttribute("id", "videoTag||" + n.identity),
          r.setAttribute("class", "videoTag"),
          track.on("switchedOff", () => {
            console.log(`Remote track ${track} was switched off`),
              (document.getElementById(
                "studentVideo_" + n.identity
              ).style.display = "none"),
              T.includes(n.identity) && T.splice(T.indexOf(n.identity), 1),
              E();
          }),
          track.on("switchedOn", () => {
            console.log(`Remote track ${track} was switched on`), E();
          })),
          t.appendChild(r);
      }
      e.on("subscribed", (r) => {
        ...
        "video" === e.kind &&
          ...
          i.setAttribute("id", "videoTag||" + n.identity),
          i.setAttribute("class", "videoTag"),
          r.on("switchedOff", () => {
            console.log(`Remote track ${r} has switched off`),
              (document.getElementById(
                "studentVideo_" + n.identity
              ).style.display = "none"),
              T.includes(n.identity) && T.splice(T.indexOf(n.identity), 1),
          ...
          r.on("switchedOn", () => {
            console.log(`Remote track ${r} was switched on`), E();
          })),
          t.appendChild(i);
      }),
        e.on("unsubscribed", P);
    ...
    function x(e) {
      S < 10 && T.push(e.identity),
        O.includes(e.identity) || O.push(e.identity),
        S++;
      const t = document.getElementById("studentVideo_" + e.identity);
      e.tracks.forEach((n) => {
        "audio" === n.kind
          ? R(n, t, e)
          : (R(n, t, e),
    ...
    function L(e) {
      (l.innerHTML = e.identity),
        e.tracks.forEach((t) => {
          "audio" === t.kind
            ? R(t, u, e)
            : "video" === t.kind &&
              "teacherScreen" !== t.trackName &&
              (R(t, u, e), (g = !0));
        }),
        e.on("trackPublished", (t) => {
          "audio" === t.kind
            ? R(t, u, e)
            : "video" === t.kind &&
              "teacherScreen" !== t.trackName &&
    ...
    function j(e) {
      ...
      t.setAttribute("class", "studentVideoDiv_" + e.identity),
        t.setAttribute("id", "studentVideo_" + e.identity);
      const n = document.createElement("span");
      n.setAttribute("id", "studentSpan_" + e.identity),
        n.setAttribute("class", "studentSpan"),
        (n.innerHTML = e.identity),
        t.appendChild(n),
        S >= 10 && (t.style.display = "none"),
        document.getElementsByClassName("grid")[0].prepend(t);
    }
    function A(e, t) {
      if ("student" === t) {
        document.getElementById("studentVideo_" + e.identity).remove();
      }
      (function (e) {
        return Array.from(e.tracks.values())
          .filter(function (e) {
            return e.track;
          })
          .map(function (e) {
    ...
    function D(e) {
      console.log("Room joined: " + e),
        ...
        e.participants.forEach((e) => {
          if (
            (console.log("Participant already connected: " + e.identity),
            e.identity === v)
          )
            L(e),
              (document.getElementById("liTeacher").style.visibility =
                "visible"),
              g ||
                (document.getElementById("noCameraImg").style.display =
                  "block");
          else {
            const t = document.createElement("div");
            (t.id = "audioPreview_" + e.identity), j(e), x(e);
          }
        }),
        e.on("participantConnected", (e) => {
          if (
            (console.log("New room connection: " + e.identity),
            e.identity === v)
          )
            L(e),
              (document.getElementById("liTeacher").style.visibility =
        ...
        e.on("dominantSpeakerChanged", (e) => {
          console.log("Dominant speaker is " + e.identity),
            (function (e) {
              const t = document.querySelector("li.dominant_speaker");
              if ((t && t.classList.remove("dominant_speaker"), e)) {
                const t = document.getElementById("studentVideo_" + e.identity);
                t && t.classList.add("dominant_speaker");
              }
            })(e);
        }),
        e.on("participantDisconnected", (e) => {
          e.identity === v
            ? ((document.getElementById("liTeacher").style.visibility =
              ...
              A(e, "teacher"))
            : (A(e, "student"),
              O.includes(e.identity) && O.splice(O.indexOf(e.identity), 1),
              E());
        });
    }
    function I(e, t) {
        ...
        o.forEach((e) => {
          ...
          (_ = r
            .connect(e, {
              ...
              preferredVideoCodecs: [{ codec: "VP8", simulcast: !0 }],
            })
            .then(D, (e) => {
              console.log(e);
            }));
    ...
    function M(e, t, n) {
      navigator.mediaDevices
        .getUserMedia(e)
        .then((e) => {
          console.log("Got audio access"), (w = !0), I(t, n);
        })
        .catch((e) => {
          "NotAllowedError" == e.name && (console.log(e), (w = !1), I(t, n));
        });
    }
    !(async function () {
      document.getElementById("liTeacher").style.visibility = "hidden";
      const e = await new Promise((e, t) => {
        chrome.runtime.sendMessage({ type: "getTokenVideo" }, (n) => {
          n && n.error && t(n.error),
            chrome.runtime.onMessage.addListener((t) => {
              if (t.type && "conference" === t.type) return e(t);
            });
        });
      }).catch((e) => reject(new Error("conference error ", e)));
      if (e.error) {
      ...
      const { token: t } = e,
        ...
        { classTitle: r } = e;
      v = n;
      const u = new URL(window.location).searchParams.get("room");
      console.log(u), (h.innerHTML = r);
      let l = { audio: !0 };
      navigator.mediaDevices
        ...
        .catch((e) => {
          "NotAllowedError" == e.name && (console.log(e), (k = !1)), M(l, t, u);
        }),
        (i.onmouseout = () => {
        ...
        f.addEventListener("mouseover", function () {
          document.getElementById("micDisabledTxt").style.display = "block";
        }),
        f.addEventListener("mouseout", function () {
          document.getElementById("micDisabledTxt").style.display = "none";
        }),
        (s.onclick = () => {
          if (null !== m || void 0 !== m) {
            !s.classList.contains("muted") &&
              (C(m, "video", "mute"),
        ...
        (i.onclick = () => {
          ...
          } else alert("Blocksi conference room is not initialized yet.");
        }),
        (o.onclick = () => {
          if (null !== m || void 0 !== m) {
            i.classList.contains("muted") &&
        ...
        chrome.runtime.onMessage.addListener(function (e, t, n) {
          switch (e.type) {
            case "muteStudents":
              if ("mute" === e.action)
              ...
              else if ("unmute" === e.action)
                y && (o.click(), b && (f.style.display = "none"));
              else if ("forceMute" === e.action) {
                b = !0;
                const e = document.querySelector("li.dominant_speaker");
                e && e.classList.remove("dominant_speaker"),
                  y
                    ? ((o.style.display = "none"),
                      (f.style.display = "inline-block"))
                    : (i.click(),
                ...
                "forceUnmute" === e.action &&
                  ((b = !1), y && ((f.style.display = "none"), o.click()));
          }
        }),
        window.addEventListener("beforeunload", () => {
          chrome.runtime.sendMessage({ type: "stopConference" }),
            _.disconnect();
        });
    })();
  },
